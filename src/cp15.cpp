                    ...
                    switch(crm)
                    {
                        case 0x0:
                        {
                            switch(opcode2)
                            {
                                case 0x0:
                                {
                                    return control_arm11.whole;
                                    break;
                                }
                                case 0x1:
                                {
                                    return aux_control_arm11.whole;
                                    break;
                                }
                    ...
                    switch(crm)
                    {
                        case 0x0:
                        {
                            switch(opcode2)
                            {
                                case 0x0:
                                {
                                    control_arm11.whole = (data & 0x33e70b0f) | 0x00000078; break;
                                    break;
                                }
                                case 0x1:
                                {
                                    aux_control_arm11.whole = data & 0xf000007f; break;
                                    break;
                                }
                    ...
                    switch(crm)
                    {
                        ...
                        case 0xa:
                        {
                            switch(opcode2)
                            {
                                case 0x0:
                                {
                                    printf("Clean entire data cache\n");
                                    break;
                                }
                                case 0x1:
                                {
                        ...
                        case 0xe:
                        {
                            switch(opcode2)
                            {
                                case 0x0:
                                {
                                    printf("Clean and Invalidate entire data cache\n");
                                    break;
                                }
                                case 0x1:
                                {
                ...
                case 0x0:
                {
                    switch(crm)
                    {
                        case 0x2:
                        {
                            if(opcode2 == 0x4)
                            {
                                peripheral_port_remap.whole = data; break;
                            }
                            break;
                        }
                    }
